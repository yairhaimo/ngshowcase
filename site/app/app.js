(function () {
    'use strict';
    var app = angular.module('ngShowcase', ['ui.router', 'ui.bootstrap', 'ngResource', 'ngSanitize', 'ngAnimate', 'angularMoment', 'ngShowcase.browser', 'ngShowcase.auth', 'ngShowcase.data', 'ngShowcase.configuration', 'ngShowcase.utils', 'ngShowcase.pages.master', 'ngShowcase.pages.browse', 'ngShowcase.pages.details', 'ngShowcase.pages.add', 'ngShowcase.pages.user']);
